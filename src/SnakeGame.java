...
// To run game: java -cp lib/core.jar:src SnakeGame
...
public class SnakeGame extends PApplet {
    ...
    public void draw() {
        ...
        // Move once a frame (only if not paused)
        if (!paused) {
    ...
    public void keyPressed() {
        ...
        // Set the snake's direction depending on pressing a key
        // Map our Direction to the keyCode
        switch (keyCode) {
            case UP:
